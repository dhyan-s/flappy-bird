...
### Instructions
1. **Installation**: Clone the repository to your local machine using the command `git clone https://github.com/dhyan-s/flappy-bird-redesign` assuming you have Git installed. If not, simply download the code from here.
